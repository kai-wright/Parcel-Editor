...
class BaseEditorClass {
    ...
    registerUnique() {
        ...
        const quintessence_id = `${quintessence.type}:${quintessence.id}`;
    ...
    load(full_id) {
        ...
        const tempParcel = JSON.parse(localStorage.getItem(full_id));
    ...
    registerInvalid(full_id) {
        ...
        const knownInvalids = JSON.parse(localStorage.getItem("editor_knownInvalids") || "[]");
        knownInvalids.push([
            full_id,
            true
        ]);
