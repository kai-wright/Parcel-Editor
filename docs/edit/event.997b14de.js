...
})({"3jO5F":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "9e2cba1e997b14de";
"use strict";
...
},{}],"3Fmc5":[function(require,module,exports) {
var _editorBase = require("./editor_base");
var _regexes = require("./regexes");
// Empty add id manager
const ADD_BUTTON = document.getElementById("add_event");
...
class EventEditorClass extends (0, _editorBase.BaseEditorClass) {
    ...
    checkValidToSave() {
        ...
        if (!(0, _regexes.regex_hash_number).test(this.current.id)) {
...
// Exports
const EXPORT_BUTTON = document.getElementById("export_current");
...
},{"./editor_base":"1NhWR","./regexes":"lpqDe"}]},["3jO5F","3Fmc5"], "3Fmc5", "parcelRequirea313")

//# sourceMappingURL=event.997b14de.js.map
